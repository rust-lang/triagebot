...
pub struct HttpServer {
    ...
    current: usize,
    /// Channel for sending webhook events to the main thread, which will send
    /// to the triagebot process.
...
pub struct HttpServerHandle {
    pub addr: SocketAddr,
    /// Channel for receiving webhook events to inject into triagebot.
